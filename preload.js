...
contextBridge.exposeInMainWorld('api', {
  ...
  getRelVerbasPreview: (maxRows) => ipcRenderer.invoke('get-rel-verbas-preview', maxRows),
  getRelVerbasRubricas: () => ipcRenderer.invoke('get-rel-verbas-rubricas'),
  ...
  clearRelVerbas: () => ipcRenderer.invoke('clear-rel-verbas'),
  exportRelVerbasXlsx: (payload) => ipcRenderer.invoke('export-rel-verbas-xlsx', payload),
